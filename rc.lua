...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mywibox:setup {
        ...
        logout_menu_widget{
            onsuspend = function() awful.spawn.with_shell("betterlockscreen -s") end,
    ...
    { -- Right widgets
    layout = wibox.layout.fixed.horizontal,
    brightness_widget{ program = 'xbacklight', },
	batteryarc_widget { show_current_level = true, font = 'Play 6' },		
